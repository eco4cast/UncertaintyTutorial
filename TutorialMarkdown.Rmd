...
To perform this on the ARIMA model, we first need to create our design matrices. We need each matrix to capture the uncertainty of each input.
...
Now, we run our Sobol analysis, which gives us estimates of our Sobol first and total order indices.
